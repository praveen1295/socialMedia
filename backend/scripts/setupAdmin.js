...
const setupDefaultAdmin = async () => {
    try {
        ...
        const existingAdmin = await Admin.findOne({ email: 'admin@socialmedia.com' });
        if (existingAdmin) {
        ...
        console.log('🔐 Permissions: user-management, post-management, content-moderation, analytics, system-settings');
