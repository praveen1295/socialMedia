...
const Signup = () => {
    ...
    const signupHandler = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(config.API_ENDPOINTS.USER.REGISTER, formData, {
                headers: {
    ...
    return (
        <div className='flex items-center w-screen h-screen justify-center bg-gray-50'>
            <form onSubmit={signupHandler} className='shadow-lg flex flex-col gap-4 p-8 bg-white rounded-lg w-full max-w-md'>
                <div className='my-4 text-center'>
                    <h1 className='text-center font-bold text-2xl text-gray-800'>SocialMedia</h1>
                    <p className='text-sm text-center text-gray-600 mt-2'>Create your account to get started</p>
                </div>
                ...
                <div>
                    ...
                    <Textarea
                        ...
                        maxLength={160}
                    />
                    <p className='text-xs text-gray-500 text-right'>{input.bio.length}/160</p>
                </div>
