...
export const config = {
    ...
    API_ENDPOINTS: {
        ...
        POST: {
            ...
            EDIT_COMMENT: (commentId) => `${API_BASE_URL}/api/v1/post/comment/${commentId}/edit`,
            DELETE_COMMENT: (commentId) => `${API_BASE_URL}/api/v1/post/comment/${commentId}/delete`,
        },
        MESSAGE: {
        ...
        ACCOUNT_DASHBOARD: {
            ...
            USER_HISTORY: (userId) => `${API_BASE_URL}/api/v1/account-dashboard/user/${userId}`,
        }
    },
    // Media configuration
    MEDIA: {
